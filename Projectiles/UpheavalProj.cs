        ...
        public override void AI()
        {
			...
			if (flag14)
			{
				...
				if (projectile.localAI[0] > 32f)
				{
					...
					num438 *= num440;
					num439 *= num440;
					Projectile.NewProjectile(value10.X, value10.Y, num438, num439, mod.ProjectileType("HotBoulder"), (int)((double)projectile.damage * 0.5f), projectile.knockBack, projectile.owner, 0f, 0f);
					return;
				}
			}
        }
